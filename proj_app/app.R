  ...
  nav_panel(
    ...
    grid_container(
      ...
      grid_card(
        area = "calendar",
        full_screen = TRUE,
        card_body(plotlyOutputgrp("Calendar", plotname = "calendar"))
      ),
      grid_card(
        area = "barchart",
        full_screen = TRUE,
...
ui <- page_navbar(
  ...
  nav_panel(
    ...
    grid_page(
      ...
      #       row_sizes = c("1fr"),,
      #       col_sizes = c("0.95fr","1.1fr","0.95fr"),,
      #       gap_size = "0px",,
      #       grid_card(,
      #         card_header("Singhealth",,
      #                     tooltip(,
      ...
      #       ),,
      #       grid_card(,
      #         card_header("National University Health System",,
      #                     tooltip(,
      #                       bs_icon("question-circle"),,
      #                       "AH = Alexendra Hospital,",,
      ...
      #       ),,
      #       grid_card(,
      #         card_header("National Healthcare Group",,
      #                     tooltip(,
      #                       bs_icon("question-circle"),,
  ...
  #   icon = icon("hospital"),
  #   grid_page(
  #     layout = c("datesettings hospsettings",
  #       "tabset       tabset      "
  #     ),
  #     gap_size = "0px",
  #     col_sizes = c(
  ...
  #         grid_container(
  #           layout = c(
  #             "selecthosp1 selecthosp2 selecthosp3"
  #           ),
  #           row_sizes = c(
  #             "1fr"
  #           ),
  ...
  #                                         )
  #             ),
  #             card_body(radioButtonshosp("SHradio"))
  #           ),
  #           grid_card(
  #             area = "selecthosp2",
  #             card_header(
  ...
  #                                         )
  #             ),
  #             card_body(radioButtonshosp("NUHSradio"))
  #           ),
  #           grid_card(
  #             area = "selecthosp3",
  #             card_header(
  ...
  #                                         )
  #             ),
  #             card_body(radioButtonshosp("NHGradio"))
  #           )
  #         )
  #       )
  #     ),
...
server <- function(input, output) {
  ...
  # output$calcalendar <- renderPlotly({
